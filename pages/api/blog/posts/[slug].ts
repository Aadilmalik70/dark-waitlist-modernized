...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  switch (req.method) {
    ...
    case 'PATCH':
      return await updatePostStatus(req, res, slug);
    default:
...
async function updatePostStatus(req: NextApiRequest, res: NextApiResponse, slug: string) {
  const connection = await getConnection();
